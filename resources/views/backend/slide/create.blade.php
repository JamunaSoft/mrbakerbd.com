...
@section('content')
         ...
         <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <!-- End Page Header -->
            <form class="add-new-post" action="{{ route('admin.slides.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                        ...
                        <div class="col">
                          <div class="form-row">
                            <div class="form-group col-md-4">
                              ...
                              <input class="form-control form-control-md mb-3 @error('text') is-invalid @enderror" type="text" name="text" id="text" placeholder="Button Text">
                              @error('text')
                            ...
                            <div class="form-group col-md-4">
                              ...
                              <input class="form-control form-control-md mb-3 @error('url') is-invalid @enderror" type="text" name="url" id="url" placeholder="URL">
                              @error('url')
                                <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                                </span>
