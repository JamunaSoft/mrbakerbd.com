...
@section('content')
         ...
         <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <!-- End Page Header -->
            <form class="add-new-post" action="{{ route('admin.pages.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                      ...
                      <div class="row">
                        <div class="col">
                          <div class="form-group">
                            ...
                            <input class="form-control form-control-md mb-3 @error('title') is-invalid @enderror" type="text" name="title" id="title" required placeholder="Title">
                            @error('title')
