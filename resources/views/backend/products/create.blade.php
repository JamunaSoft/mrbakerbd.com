...
@section('content')
         ...
         <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <!-- End Page Header -->
            <form class="add-new-post" action="{{ route('admin.products.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="card card-small mb-3">
                  <ul class="list-group list-group-flush">
                        ...
                        <div class="col">
                            <div class="form-row">
                              <div class="form-group col-md-6">
                                ...
                                <input class="form-control form-control-md mb-3 @error('name') is-invalid @enderror" type="text" name="name" id="name" required placeholder="Product Name">
                                @error('name')
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input class="form-control form-control-md mb-3 @error('code') is-invalid @enderror" type="text" name="code" id="code" placeholder="Product Code">
                                @error('code')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control form-control-md mb-3 @error('short_desc') is-invalid @enderror" type="text" name="short_desc" id="short_desc" placeholder="Short Description">
                              @error('short_desc')
                                <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-row" id="simple_product">
                              <div class="form-group col-md-6">
                                <label for="regular_price">{{ __('Regular Price') }}</label>
                                <input class="form-control form-control-md mb-3 @error('regular_price') is-invalid @enderror" type="text" name="regular_price" id="regular_price" placeholder="Regular Price" required>
                                @error('regular_price')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                              ...
                              <div class="form-group col-md-6">
                                ...
                                <input class="form-control form-control-md mb-3 @error('special_price') is-invalid @enderror" type="text" name="special_price" id="special_price" placeholder="Special Price">
                                @error('special_price')
                                  <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                  </span>
                            ...
                            <div class="form-group" id="variable_product" style="display:none">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control form-control-md mb-3 @error('tags') is-invalid @enderror" name="tags" id="tags">
                            </div>
                            <div class="form-row">
                    ...
                    <li class="list-group-item d-flex px-3">
                      <button class="btn btn-sm btn-accent ml-auto" type="submit"><i class="material-icons">save</i> Save</button>
                    </li>
                  </ul>
                </div>
              </div>
                            ...
                            <div class="row">
                              <div class="col-sm-12 imgUp">
                                <div id="main-image-drop-area" class="custom-drop-area">
                                  ...
                                  <div id="main-image-message" class="gallery-message">Drop image here or click to upload</div>
                                  <div id="main-image-preview" class="gallery-preview"></div>
                                </div>
                              </div>
                            </div>
                          </div>
...
function updatePreview() {
    ...
    message.style.display = filesArray.length ? 'none' : 'block';
}
